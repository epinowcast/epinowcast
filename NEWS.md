...
- Fixed some typos in `single-timeseries-rt-estimation.Rmd`. The `WORDLIST` used by spelling has also been updated by eliminate false positives. See #341 by @Bisaloo.
