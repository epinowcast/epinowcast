...
- Fixed bug in `enw_aggregate_cumulative()` where cumulative counts could incorrectly decrease at timestep boundaries when max_delay was an even multiple of the aggregation timestep. Fixes #511 by @seabbs.
