...
#> 1: <data.table[40x5]>   41        41         1        40 2021-08-22      day
```
...
cases). We also pass our preprocessed data (`pobs`), and our model
modules (`expectation_module`, `reference_module`, and `report_module`)
to `epinowcast`, where they are combined and used to fit the model.

*Note: The first time `epinowcast` is run the `cmdstan` model will need
to compile but for subsequent uses, it should be cached. This behaviour
can also be managed manually using `enw_model()`.*
...
#> 1: <CmdStanMCMC[42]> <list[116]> <list[7]>    1000     1.02
...
#>  2:                 1    38             0  69.048     69 0.2138732 0.0000 69
#>  3:                 1    37             0  47.080     47 0.2750921 0.0000 47
#>  4:                 1    36             0  65.218     65 0.4761331 0.0000 65
#>  5:                 1    35             0  50.265     50 0.5559533 0.0000 50
#>  6:                 1    34             0  36.237     36 0.4827671 0.0000 36
#>  7:                 1    33             0  94.459     94 0.6875986 0.0000 94
#>  8:                 1    32             0  91.854     92 0.9389172 1.4826 91
#>  9:                 1    31             0 100.174    100 1.1202584 1.4826 99
#> 10:                 1    30             0  87.458     87 1.2976594 1.4826 86
#>     q95      rhat  ess_bulk ess_tail
#>  1:  72        NA        NA       NA
#>  2:  69 0.9992809  920.7785 920.7785
#>  3:  48 0.9997223  921.7088 929.4499
#>  4:  66 0.9999805  907.0988 896.5353
#>  5:  51 0.9988003  867.0232 811.3822
#>  6:  37 0.9995126  840.7693 821.7969
#>  7:  96 1.0018235 1016.0617 940.6798
#>  8:  94 1.0040355  835.9370 814.3828
#>  9: 102 1.0034747  946.3429 981.0620
#> 10:  90 0.9991593 1098.0683 982.0464
```
...
#>     5:                 1    33             0      1          5     5    434
#>    ---                                                                     
#> 33996:                 1     0             1      2        496   996   2147
#> 33997:                 1     0             1      2        497   997   2686
#> 33998:                 1     0             1      2        498   998   1936
#> 33999:                 1     0             1      2        499   999   1908
#> 34000:                 1     0             1      2        500  1000   1963
...
issues.
>>>>>>> cf39fcd6 (Automatic readme update [ci skip])
