...
`epinowcast` is still in development and so the following case study has
...
[`enw_linelist_to_incidence()`](https://package.epinowcast.org/reference/enw_linelist_to_incidence.md)
function,
...
- Create the real-time dataset (`rt_nat_germany`) by filtering the data
...
[`epinowcast::enw_expectation()`](https://package.epinowcast.org/reference/enw_expectation.md)
function as follows,
...
[`epinowcast::enw_reference()`](https://package.epinowcast.org/reference/enw_reference.md)
function as follows,
...
\\\begin{align} n\_{t,d} \mid \lambda\_{t},p\_{t,d} &\sim \text{Poisson}
