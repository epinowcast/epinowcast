...
machinery; [`rw()`](https://package.epinowcast.org/reference/rw.md),
[`ar()`](https://package.epinowcast.org/reference/ar.md), and the
general [`arima()`](https://package.epinowcast.org/reference/arima.md)
share one backend.
...
[`arma()`](https://package.epinowcast.org/reference/arma.md) add an MA
component to the same machinery. MA structure is most useful as part of
an ARMA model rather than on its own, so it is covered briefly at the
...
kernel](https://package.epinowcast.org/articles/arima.md) built from the
impulse response; both compose with a single matrix multiplication onto
unit-normal shocks. When `by` is supplied each group has its own column
of unit-normal shocks; the AR/MA parameters and latent standard
...
notes](https://package.epinowcast.org/articles/gaussian-process.html#differencing).
...
notes](https://package.epinowcast.org/articles/gaussian-process.md)
...
The [implementation
notes](https://package.epinowcast.org/articles/arima.md) cover the
...
on [`arima()`](https://package.epinowcast.org/reference/arima.md), the
aliases [`ar()`](https://package.epinowcast.org/reference/ar.md) /
[`ma()`](https://package.epinowcast.org/reference/ma.md) /
[`arma()`](https://package.epinowcast.org/reference/arma.md), and
[`rw()`](https://package.epinowcast.org/reference/rw.md) lets each group
draw its own innovation series; the AR/MA parameters and latent standard
deviation are currently shared across groups (per-group parameters are a
planned extension).
...
[`gp()`](https://package.epinowcast.org/reference/gp.md), and
...
An [`arima()`](https://package.epinowcast.org/reference/arima.md) or
[`gp()`](https://package.epinowcast.org/reference/gp.md) term on the
reference delay mean, for instance, models a reporting delay that drifts
over time. See the
[ARIMA](https://package.epinowcast.org/articles/arima.md) and [Gaussian
process](https://package.epinowcast.org/articles/gaussian-process.md)
