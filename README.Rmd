...
The `epinowcast` package is designed to provide users with a flexible and customizable modelling framework. The package comes equipped with several modules that users can utilize to construct models, and also enables users to create their own modules. These ensires that models are tailored to the user's specific data and context.
