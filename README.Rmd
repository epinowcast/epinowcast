...
to help you [get started nowcasting](https://package.epinowcast.org/articles/epinowcast.html),
provide a [quick reference of model features](https://package.epinowcast.org/articles/features.html),
and to [highlight other features with case studies](https://package.epinowcast.org/articles/germany-age-stratified-nowcasting.html).
