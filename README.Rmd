...
Print the output from `{epinowcast}` which includes disagnostic information, the data used for fitting, and the `{cmdstanr`} object.
...
Plot the nowcast against currently observed data (or optionally more recent data for comparison purposes).
