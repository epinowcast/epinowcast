...
- [Package website](https://package.epinowcast.org/): This includes a function reference, model outline, and case studies making use of the package. The development version of our documentation (corresponding to our `develop` branch) is available [here](https://package.epinowcast.org/dev/).
