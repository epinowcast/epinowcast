...
vignette](https://package.epinowcast.org/dev/articles/latent-processes.md)
works through
[`gp()`](https://package.epinowcast.org/dev/reference/gp.md) on the
growth rate and compares it to
[`rw()`](https://package.epinowcast.org/dev/reference/rw.md),
[`arima()`](https://package.epinowcast.org/dev/reference/arima.md), and
...
[`gp()`](https://package.epinowcast.org/dev/reference/gp.md) does not
...
used for
[`arima()`](https://package.epinowcast.org/dev/reference/arima.md), so
the gather stays aligned with the deduplicated design rows.

## Differencing order

The `d` argument integrates the realisation \\d\\ times before it enters
the predictor, matching the `d` of
[`arima()`](https://package.epinowcast.org/dev/articles/arima.md). It
...
[`arima()`](https://package.epinowcast.org/dev/reference/arima.md), but
...
[`gp()`](https://package.epinowcast.org/dev/reference/gp.md) works on
every module that takes a formula, each with its own prior prefix:
...
Putting a [`gp()`](https://package.epinowcast.org/dev/reference/gp.md)
term on the reference delay mean, for instance, models a reporting delay
that drifts smoothly over time, while a
[`gp()`](https://package.epinowcast.org/dev/reference/gp.md) on the
