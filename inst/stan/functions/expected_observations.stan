...
// on a given day effects that occured the reference day (or alternatively the
// logit hazard of this), and the hazard of reporting on a given day given
