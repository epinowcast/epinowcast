...
|unadjusted | 4300| 4188| 4405|



We also plot the posterior of the attack size under each model against the
realised truth.


``` r
ggplot(attack, aes(x = attack, fill = model)) +
  ...
  labs(
    x = "Cumulative attack size", y = "Posterior density", fill = NULL,
    linetype = NULL
  ) +
  theme_bw()
```

![Posterior of the cumulative attack size under each model against the realised truth (dashed line).](figures/susceptible-depletion-plot-attack-1.png)
