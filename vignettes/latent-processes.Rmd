...
We also keep the eventually-observed counts so each nowcast can be shown against the data that arrived later.
...
|variable            |  mean|     q5|   q95|
|:-------------------|-----:|------:|-----:|
|expr_arima_pacf[1]  | 0.016| -0.829| 0.848|
|expr_arima_sigma[1] | 0.030|  0.011| 0.057|
...
|:-----------------------------------------|--------:|------------:|-----------:|---------:|
|rw(week)                                  |    1.008|          190|           0|       128|
|arima(week, age_group, 1, 1, 0)           |    1.012|          186|           0|       135|
|ar(day, age_group, 1)                     |    1.013|          213|           0|       121|
|(1 &#124; week:.group)                    |    1.020|          157|           1|       110|
|(1 &#124; day_of_week)                    |    1.010|          214|           0|       395|
|(1 &#124; day_of_week) + arima(week, ...) |    1.026|          197|           0|       399|
