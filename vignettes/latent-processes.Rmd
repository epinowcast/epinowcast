...
- **Random walk** via `rw(week, age_group)`. The growth rate drifts: each step builds on the last with no pull back towards a mean. This is ARIMA(0, 1, 0).
...
- **Gaussian process** via `gp(week, age_group)`. A smooth function of time with a length scale that controls how quickly the growth rate can change; a flexible non-parametric smoother.
...
|variable            |   mean|     q5|   q95|
|:-------------------|------:|------:|-----:|
|expr_arima_pacf[1]  | -0.026| -0.849| 0.881|
|expr_arima_sigma[1] |  0.030|  0.011| 0.053|
...
|variable         |  mean|    q5|   q95|
|:----------------|-----:|-----:|-----:|
|expr_gp_rho[1]   | 3.324| 1.360| 6.309|
|expr_gp_alpha[1] | 0.042| 0.013| 0.088|
...
#> Warning: 500 of 1000 (50.0%) transitions hit the maximum treedepth limit of 12.
...
|:-----------------------------------------|--------:|------------:|-----------:|---------:|
|rw(week, age_group)                       |    1.027|          141|           0|        82|
|arima(week, age_group, 1, 1, 0)           |    1.007|          161|           0|        90|
|ar(day, age_group, 1)                     |    1.026|          219|           0|       115|
|gp(week, age_group)                       |    1.021|          171|           0|        70|
|(1 &#124; week:.group)                    |    1.012|          209|           0|        76|
|(1 &#124; day_of_week)                    |    1.016|          190|           0|        73|
|(1 &#124; day_of_week) + arima(week, ...) |    2.750|            3|           0|       717|
...
See the [ARIMA](arima.html) and [Gaussian process](gaussian-process.html) implementation notes for the per-module details.
