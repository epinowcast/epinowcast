...
|variable            |  mean|     q5|   q95|
|:-------------------|-----:|------:|-----:|
|expr_arima_pacf[1]  | 0.017| -0.859| 0.849|
...
Because these are NUTS fits we can read off standard convergence diagnostics for each model: the largest R-hat and smallest bulk effective sample size across all parameters, and the number of divergent transitions.
...
|model                                     | max_rhat| min_ess_bulk| divergences|
|:-----------------------------------------|--------:|------------:|-----------:|
|rw(week)                                  |    1.025|          253|           0|
|arima(week, age_group, 1, 1, 0)           |    1.010|          321|           0|
|ar(day, age_group, 1)                     |    1.018|          129|           0|
|(1 &#124; week:.group)                    |    1.015|          235|           0|
|(1 &#124; day_of_week)                    |    1.011|          298|           0|
|(1 &#124; day_of_week) + arima(week, ...) |    1.009|          280|           0|
