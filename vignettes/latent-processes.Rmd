...
|variable            |  mean|     q5|   q95|
|:-------------------|-----:|------:|-----:|
|expr_arima_pacf[1]  | 0.009| -0.826| 0.813|
|expr_arima_sigma[1] | 0.030|  0.011| 0.054|
...
|:-----------------------------------------|--------:|------------:|-----------:|---------:|
|rw(week)                                  |    1.020|          199|           1|       169|
|arima(week, age_group, 1, 1, 0)           |    1.031|          166|           0|        99|
|ar(day, age_group, 1)                     |    1.029|          123|           0|       120|
|(1 &#124; week:.group)                    |    1.031|          126|           0|        92|
|(1 &#124; day_of_week)                    |    1.013|          237|           0|       281|
|(1 &#124; day_of_week) + arima(week, ...) |    1.022|          196|           0|       335|
...
The same `rw()`, `ar()`, `arima()`, and random-effect terms can be placed on any module's formula: an `arima()` term on the reference delay mean, for instance, models a reporting delay that drifts over time.
