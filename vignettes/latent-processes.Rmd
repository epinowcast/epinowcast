...
- **Pure moving-average residuals** via `ma(day, age_group, q = 7)`. A stationary short-memory variant of the same machinery: shocks influence the series for `q` steps and then drop out, with no autoregressive feedback. Taking `q = 7` lets the latent series carry one week of moving-average memory.
...
#> ℹ Using `tempdir()` at
#>   /var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T//Rtmp8YYTsG for the
...
#> 
#> 
#> Chain 1 Warning: file '/var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T/Rtmp8YYTsG/init-a9e92e402bf1_1.json' is being used to initialize all 4 chains!
```
...
#> 
#> 
#> Chain 1 Warning: file '/var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T/Rtmp8YYTsG/init-a9e9352abf83_1.json' is being used to initialize all 4 chains!
```
...
#> 
#> 
#> Chain 1 Warning: file '/var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T/Rtmp8YYTsG/init-a9e9119d0100_1.json' is being used to initialize all 4 chains!
```
...
|variable            |  mean|    q5|   q95|
|:-------------------|-----:|-----:|-----:|
|expr_arima_pacf[1]  | 0.037| 0.000| 0.100|
|expr_arima_sigma[1] | 0.007| 0.005| 0.008|
...
It is stationary (no integration) and has only `q` steps of memory: a shock at day `t` influences the series for days `t, t + 1, ..., t + q` and then drops out.
...
Picking `q = 7` lets the noise window span one week, so a daily shock can decay across the following week without persisting indefinitely as it would under an AR component.
...
#> 
#> 
#> Chain 1 Warning: file '/var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T/Rtmp8YYTsG/init-a9e92d8cc208_1.json' is being used to initialize all 4 chains!
```
...
![Nowcast under an MA(7) residual on day.](figures/latent-processes-ma-plot-1.png)

Note that `ma(q = 7)` is *not* a periodic-by-weekday model: it gives correlated noise over a week's window, not a recurring weekly cycle.
...
#> 
#> 
#> Chain 1 Warning: file '/var/folders/cg/c1zk6s7n061cj176r8lp7_900000gn/T/Rtmp8YYTsG/init-a9e941605bed_1.json' is being used to initialize all 4 chains!
```
