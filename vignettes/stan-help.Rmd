...
During the initial model fitting process, you may want to start with a lower number for `iter_warmup` such as 500-750 iterations per chain and increase to 1000-2000 per chain (or more) if needed.
