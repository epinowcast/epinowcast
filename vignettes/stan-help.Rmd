...
You can take several steps to speed up your model fitting time:
...
1. Increase `max_treedepth` to an integer value greater than `10` up to `15`. This value controls the size of the trajectory taken by the sample (in power of 2) take for each step. If this value is too low, the smapler may terminate too early causing excess runtimes.
