...
This pattern mirrors the separation in `EpiNow2` between [`simulate_infections()`](https://epiforecasts.io/EpiNow2/reference/simulate_infections.html) and [`forecast_infections()`](https://epiforecasts.io/EpiNow2/reference/forecast_infections.html).
In simulation any sampled parameter can be fixed via `parameters`, while forecasting currently overrides the growth rate.
