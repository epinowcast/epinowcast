...
#>          age_group location report_date reference_date new_confirm confirm delay
#>       1:     00-04    DE-BY  2021-04-06           <NA>           0       0     0
#>       2:     00-04    DE-BY  2021-04-07           <NA>           0       0     1
#>       3:     00-04    DE-BY  2021-04-08           <NA>           0       0     2
#>       4:     00-04    DE-BY  2021-04-09           <NA>           0       0     3
#>       5:     00-04    DE-BY  2021-04-10           <NA>           0       0     4
#>      ---                                                                        
#> 2049593:       80+    DE-TH  2021-10-19     2021-10-18           0       0     1
#> 2049594:       80+    DE-TH  2021-10-20     2021-10-18           0       0     2
#> 2049595:       80+    DE-TH  2021-10-19     2021-10-19           1       1     0
#> 2049596:       80+    DE-TH  2021-10-20     2021-10-19           0       1     1
#> 2049597:       80+    DE-TH  2021-10-20     2021-10-20           0       0     0
```
...
#> 1: <data.table[1425x8]> <data.table[1425x9]> <data.table[62x8]> <data.table[0x4]>
#>     reporting_triangle      metareference          metareport          metadelay
#> 1: <data.table[62x32]> <data.table[62x8]> <data.table[91x10]> <data.table[30x4]>
#>    time snapshots by groups max_delay   max_date timestep
#> 1:   62        62         1        30 2021-07-01      day
```
...
retro_germany_pobs
#>                     obs          new_confirm             latest missing_reference
#> 1: <data.table[1860x8]> <data.table[1860x9]> <data.table[62x8]> <data.table[0x4]>
#>     reporting_triangle      metareference           metareport          metadelay
#> 1: <data.table[62x32]> <data.table[62x8]> <data.table[120x10]> <data.table[30x4]>
#>    time snapshots by groups max_delay   max_date timestep
#> 1:   62        62         1        30 2021-07-30      day
```
