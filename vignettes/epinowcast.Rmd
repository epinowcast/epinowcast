...
Priors are specified using the distributions of the `distspec` package (for example `distspec::Normal()`), as in `EpiNow2`, and passed as a named list to the `priors` argument of `epinowcast()`.
