...
::: {.alert .alert-warning}
**Important:** The default lognormal reporting delay may not suit all data.
It can fail with multimodal delays (see [#319](https://github.com/epinowcast/epinowcast/issues/319)).
Use posterior predictive checks and consider alternatives when needed.
See the [model definition vignette](https://package.epinowcast.org/articles/model.html) for guidance.
:::
...
Note that the default distribution is lognormal, hence the distribution argument could be omitted here.
