...
nowcast <- epinowcast(data = pobs,
  ...
  fit = enw_fit_opts(
    ...
    show_messages = interactive(), init_method = "pathfinder"
  ),
  model = model
)
#> Path [1] :Initial log joint density = -12478.816861 
#> Path [3] :Initial log joint density = -12478.816861 
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>              99      -4.932e+03      6.927e-03   9.073e+00    1.882e-01  1.882e-01      2476 -5.090e+03 -5.090e+03                   
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>              99      -4.932e+03      6.927e-03   9.073e+00    1.882e-01  1.882e-01      2476 -5.098e+03 -5.098e+03                   
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -inf, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[3] is nan, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[3] is nan, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
...
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[4] is nan, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -inf, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
...
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             199      -1.528e+03      7.201e-01   8.101e+01    1.000e+00  1.000e+00      4976 -1.699e+03 -1.699e+03                   
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             199      -1.528e+03      7.201e-01   8.101e+01    1.000e+00  1.000e+00      4976 -1.696e+03 -1.696e+03                   
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             299      -1.437e+03      2.272e-02   2.129e+01    1.000e+00  1.000e+00      7476 -1.767e+03 -1.767e+03                   
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             299      -1.437e+03      2.272e-02   2.129e+01    1.000e+00  1.000e+00      7476 -1.770e+03 -1.770e+03                   
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             399      -1.434e+03      3.680e-03   3.794e+00    1.000e+00  1.000e+00      9976 -3.792e+03 -3.792e+03                   
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             399      -1.434e+03      3.680e-03   3.794e+00    1.000e+00  1.000e+00      9976 -6.034e+03 -6.034e+03                   
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             499      -1.434e+03      1.384e-04   5.430e-01    6.649e-01  6.649e-02     12476 -1.691e+03 -1.691e+03                   
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             499      -1.434e+03      1.384e-04   5.430e-01    6.649e-01  6.649e-02     12476 -1.705e+03 -1.705e+03                   
#> Path [1] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             521      -1.434e+03      1.483e-04   1.953e-01    1.000e+00  1.000e+00     13026 -1.711e+03 -1.711e+03                   
#> Path [1] :Best Iter: [247] ELBO (-1595.509888) evaluations: (13026) 
#> Path [3] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             521      -1.434e+03      1.483e-04   1.953e-01    1.000e+00  1.000e+00     13026 -1.712e+03 -1.712e+03                   
#> Path [3] :Best Iter: [247] ELBO (-1603.103997) evaluations: (13026) 
#> Path [2] :Initial log joint density = -12478.816861 
#> Path [4] :Initial log joint density = -12478.816861 
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>              99      -4.932e+03      6.927e-03   9.073e+00    1.882e-01  1.882e-01      2476 -5.091e+03 -5.091e+03                   
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>              99      -4.932e+03      6.927e-03   9.073e+00    1.882e-01  1.882e-01      2476 -5.088e+03 -5.088e+03                   
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[1] is -inf, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 13, column 0) (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/delay_lpmf.stan', line 61, column 4, included from 
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Exception: Exception: Exception: neg_binomial_2_log_lpmf: Log location parameter[3] is nan, but must be finite! (in '/tmp/RtmpiIaSrZ/include_1/stan/functions/obs_lpmf.stan', line 31, column 4, included from 
...
#> '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 18, column 0) (in '/tmp/RtmpiIaSrZ/model-19a9173ca5a.stan', line 407, column 8 to line 412, column 10) 
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             199      -1.528e+03      7.201e-01   8.101e+01    1.000e+00  1.000e+00      4976 -1.678e+03 -1.678e+03                   
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             199      -1.528e+03      7.201e-01   8.101e+01    1.000e+00  1.000e+00      4976 -1.686e+03 -1.686e+03                   
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             299      -1.437e+03      2.272e-02   2.129e+01    1.000e+00  1.000e+00      7476 -1.793e+03 -1.793e+03                   
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             299      -1.437e+03      2.272e-02   2.129e+01    1.000e+00  1.000e+00      7476 -1.743e+03 -1.743e+03                   
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             399      -1.434e+03      3.680e-03   3.794e+00    1.000e+00  1.000e+00      9976 -4.231e+03 -4.231e+03                   
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             399      -1.434e+03      3.680e-03   3.794e+00    1.000e+00  1.000e+00      9976 -3.355e+03 -3.355e+03                   
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             499      -1.434e+03      1.384e-04   5.430e-01    6.649e-01  6.649e-02     12476 -1.721e+03 -1.721e+03                   
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             499      -1.434e+03      1.384e-04   5.430e-01    6.649e-01  6.649e-02     12476 -1.684e+03 -1.684e+03                   
#> Path [2] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             521      -1.434e+03      1.483e-04   1.953e-01    1.000e+00  1.000e+00     13026 -1.704e+03 -1.704e+03                   
#> Path [2] :Best Iter: [245] ELBO (-1599.141301) evaluations: (13026) 
#> Path [4] : Iter      log prob        ||dx||      ||grad||     alpha      alpha0      # evals       ELBO    Best ELBO        Notes  
#>             521      -1.434e+03      1.483e-04   1.953e-01    1.000e+00  1.000e+00     13026 -1.699e+03 -1.699e+03                   
#> Path [4] :Best Iter: [254] ELBO (-1603.669489) evaluations: (13026) 
#> Total log probability function evaluations:56004 
...
#>  3:                 1    37             0  47.094     47 0.3086410 0.0000    47
#>  4:                 1    36             0  65.220     65 0.4709796 0.0000    65
#>  5:                 1    35             0  50.281     50 0.5369612 0.0000    50
#>  6:                 1    34             0  36.230     36 0.4871728 0.0000    36
#>  7:                 1    33             0  94.511     94 0.7392059 0.0000    94
#>  8:                 1    32             0  91.767     92 0.9292871 1.4826    91
#>  9:                 1    31             0 100.189    100 1.1128870 1.4826    99
#> 10:                 1    30             0  87.332     87 1.2203546 1.4826    86
#>       q95      rhat  ess_bulk  ess_tail
#>     <num>     <num>     <num>     <num>
#>  1:    72        NA        NA        NA
#>  2:    69 1.0001597 1029.1252 1027.7732
#>  3:    48 0.9988694  859.4810  827.6097
#>  4:    66 0.9986195  972.7744  873.1858
#>  5:    51 0.9980601 1059.0522 1005.0365
#>  6:    37 1.0006540  984.2887  985.1647
#>  7:    96 1.0038901 1102.5960  954.1587
#>  8:    94 1.0027215  839.7960  950.4702
#>  9:   102 1.0004217  978.2751  981.3916
#> 10:    90 1.0046210  932.0495  941.0382
```
...
#>     5:                 1    33             0      1          5     5    436
#>    ---                                                                     
#> 33996:                 1     0             1      2        496   996   2035
#> 33997:                 1     0             1      2        497   997   1843
#> 33998:                 1     0             1      2        498   998   2024
#> 33999:                 1     0             1      2        499   999   2195
#> 34000:                 1     0             1      2        500  1000   1972
