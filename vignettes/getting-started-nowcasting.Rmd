...
#>                 <list>               <list>              <list>            <list>
#> 1: <data.table[860x9]> <data.table[860x11]> <data.table[41x10]> <data.table[0x6]>
#>     reporting_triangle      metareference          metareport          metadelay
#>                 <list>             <list>              <list>             <list>
#> 1: <data.table[41x42]> <data.table[41x9]> <data.table[80x12]> <data.table[40x5]>
#>     time snapshots     by groups max_delay   max_date timestep
#>    <int>     <int> <list>  <int>     <num>     <IDat>   <char>
#> 1:    41        41             1        40 2021-08-22      day
```
...
#>  2:                 1    38             0  69.054     69 0.2431936 0.0000    69
#>  3:                 1    37             0  47.084     47 0.2881441 0.0000    47
#>  4:                 1    36             0  65.206     65 0.4536185 0.0000    65
#>  5:                 1    35             0  50.279     50 0.5544966 0.0000    50
#>  6:                 1    34             0  36.240     36 0.4885065 0.0000    36
#>  7:                 1    33             0  94.501     94 0.7074599 0.0000    94
#>  8:                 1    32             0  91.871     92 0.9956658 1.4826    91
#>  9:                 1    31             0 100.183    100 1.1510151 1.4826    99
#> 10:                 1    30             0  87.312     87 1.1610357 1.4826    86
#>        q95      rhat  ess_bulk  ess_tail
#>      <num>     <num>     <num>     <num>
#>  1:  72.00        NA        NA        NA
#>  2:  69.05 1.0022660 1070.1623 1072.1087
#>  3:  48.00 1.0027199 1029.2231 1004.0967
#>  4:  66.00 0.9983595 1090.0804 1052.8611
#>  5:  51.00 0.9994480  853.0442  842.3181
#>  6:  37.00 1.0003999  955.3714  967.8057
#>  7:  96.00 1.0045206 1012.7675 1026.9796
#>  8:  94.00 0.9991883  959.3483  876.4466
#>  9: 102.00 1.0015547  948.4192  901.3271
#> 10:  89.00 1.0021850 1056.9533  932.8045
```
...
#>     5:                 1    33             0      1          5     5    436
#>    ---                                                                     
#> 33996:                 1     0             1      2        496   996   2224
#> 33997:                 1     0             1      2        497   997   2104
#> 33998:                 1     0             1      2        498   998   2065
#> 33999:                 1     0             1      2        499   999   2096
#> 34000:                 1     0             1      2        500  1000   2252
