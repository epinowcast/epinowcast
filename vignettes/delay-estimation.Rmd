...
|model      |variable         | truth|  mean|    q5|   q95|
|:----------|:----------------|-----:|-----:|-----:|-----:|
|full       |refp_mean_int[1] |   1.6| 1.588| 1.578| 1.599|
|delay-only |refp_mean_int[1] |   1.6| 1.588| 1.577| 1.600|
|full       |refp_sd_int[1]   |   0.5| 0.501| 0.491| 0.511|
|delay-only |refp_sd_int[1]   |   0.5| 0.501| 0.490| 0.511|
...
The draws bracket the simulated truth (dashed) for both models, so both recover the delay; the delay-only posterior is the tighter of the two because it does not carry latent-process uncertainty.
...
|variable         | truth|  mean|    q5|   q95|
|:----------------|-----:|-----:|-----:|-----:|
|refp_mean_int[1] |   1.6| 1.583| 1.571| 1.596|
|refp_sd_int[1]   |   0.5| 0.503| 0.494| 0.513|
