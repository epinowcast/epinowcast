...
#>    1:     2021-07-23       DE       00+      30
#>    2:     2021-07-24       DE       00+      31
#>    3:     2021-07-25       DE       00+       8
#>    4:     2021-07-26       DE       00+       9
#>    5:     2021-07-27       DE       00+      35
#>   ---                                          
#> 6023:     2021-07-23       DE     05-14       1
#> 6024:     2021-07-23       DE     15-34      21
#> 6025:     2021-07-23       DE     35-59      39
#> 6026:     2021-07-23       DE     60-79      21
#> 6027:     2021-07-23       DE       80+       5
#>       report_date
#>    1:  2021-07-23
#>    2:  2021-07-24
#>    3:  2021-07-25
...
pobs
#>                     obs           new_confirm
#> 1: <data.table[6020x9]> <data.table[6020x11]>
#>                  latest missing_reference
#> 1: <data.table[287x10]> <data.table[0x6]>
#>      reporting_triangle       metareference
#> 1: <data.table[287x42]> <data.table[287x9]>
#>              metareport          metadelay time
#> 1: <data.table[560x12]> <data.table[40x4]>   41
#>    snapshots        by groups max_delay
#> 1:       287 age_group      7        40
#>      max_date timestep
#> 1: 2021-09-01      day
```
...
#> 1: refp_mean_int[1] 1.1083702 1.0999150
#> 2:   refp_sd_int[1] 2.5938331 2.5856750
#> 3:      sqrt_phi[1] 0.6444396 0.6440095
#>            sd        mad        q5     q20
#> 1: 0.23916626 0.11090589 0.9294077 1.00725
#> 2: 0.26334423 0.12787425 2.3918925 2.48332
#> 3: 0.03645647 0.01747096 0.6145307 0.62941
#>          q80       q95      rhat ess_bulk
#> 1: 1.1955600 1.3246245 0.9991926  831.595
#> 2: 2.6957700 2.8213280 1.0023876  791.710
#> 3: 0.6588764 0.6761259 1.0072163 1142.299
#>    ess_tail
#> 1: 658.3016
#> 2: 643.9374
#> 3: 603.3725
...
<div class="figure">
<img src="figures/germany-age-stratified-nowcasting-unnamed-chunk-20-1.png" alt="plot of chunk unnamed-chunk-20" width="100%" />
...
loo_compare(loos)
#>                                                     elpd_diff
#> Reference: Age and week, Report: Day of week           0.0   
#> Reference: Age and week by age, Report: Day of week   -2.0   
#> Reference: Age, Report: Day of week                   -4.1   
#> Reference: Fixed, Report: Day of week                -85.0   
#> Reference: Fixed, Report: Fixed                     -645.3   
#>                                                     se_diff
#> Reference: Age and week, Report: Day of week           0.0 
#> Reference: Age and week by age, Report: Day of week    3.8 
#> Reference: Age, Report: Day of week                    6.5 
#> Reference: Fixed, Report: Day of week                 12.1 
#> Reference: Fixed, Report: Fixed                       48.3
```
...
|:--------------------------------------------------------|--------------:|----------:|---------------:|--------------:|------------------:|----------:|---------:|
|Reference: Fixed, Report: Fixed                          |      10.427030|   3.682110|        3.171272|      3.5744113|         -0.0805338| -0.0357143|  17.75510|
|Reference: Fixed, Report: Day of week                    |      10.326110|   2.612009|        6.783925|      0.9307692|         -0.1323391| -0.2897959|  15.37755|
|Reference: Age, Report: Day of week                      |       8.716047|   2.501557|        5.733846|      0.4803768|         -0.1229199| -0.4193878|  13.08163|
|Reference: Age and week, Report: Day of week             |       7.193438|   2.986992|        1.432653|      2.7744113|         -0.0036107|  0.0153061|  12.61224|
|Reference: Age and week by age, Report: Day of week      |       7.035887|   2.979419|        2.572465|      1.4835165|         -0.0193093| -0.2122449|  11.88776|
|Independent by age, Reference: Week, Report: Day of week |       8.061642|   4.422364|        1.176766|      2.4638932|          0.0591837| -0.0397959|  13.84694|
