...
``` r
threads <- floor(min(max(1, parallel::detectCores() /  4), 6))
options(mc.cores = 2)
```
...
#> 1: refp_mean_int[1] 1.1105097 1.1008600 0.17735220 0.11854870 0.9321619
#> 2:   refp_sd_int[1] 2.5902758 2.5828900 0.19727061 0.13464232 2.3911825
#> 3:      sqrt_phi[1] 0.6445116 0.6443145 0.02789925 0.01870819 0.6148259
#>          q20       q80       q95      rhat  ess_bulk ess_tail
#>        <num>     <num>     <num>     <num>     <num>    <num>
#> 1: 1.0090380 1.2075320 1.3127160 1.0006080  672.3209 625.1406
#> 2: 2.4750800 2.7022900 2.8092600 0.9995768  707.6434 587.3824
#> 3: 0.6287708 0.6600192 0.6751293 1.0011236 1132.8709 762.3662
```
...
#> Reference: Age and week by age, Report: Day of week   -3.1       3.4 
#> Reference: Age, Report: Day of week                   -3.6       5.9 
#> Reference: Fixed, Report: Day of week                -92.7      12.0 
#> Reference: Fixed, Report: Fixed                     -634.9      47.0
```
...
|:--------------------------------------------------------|--------------:|----------:|---------------:|--------------:|------------------:|----------:|---------:|
|Reference: Fixed, Report: Fixed                          |      10.349987|   3.758939|        3.108477|      3.4814757|         -0.0679749| -0.0275510|  17.77551|
|Reference: Fixed, Report: Day of week                    |      10.329385|   2.787943|        6.617112|      0.9233909|         -0.1182104| -0.2704082|  15.29592|
|Reference: Age, Report: Day of week                      |       8.519281|   2.589840|        5.382386|      0.5470958|         -0.1197802| -0.4132653|  12.87755|
|Reference: Age and week, Report: Day of week             |       7.249149|   3.146386|        1.447096|      2.6558085|         -0.0004710| -0.0071429|  12.71429|
|Reference: Age and week by age, Report: Day of week      |       7.166716|   3.126292|        2.467661|      1.5723705|         -0.0114600| -0.2030612|  12.20408|
|Independent by age, Reference: Week, Report: Day of week |       8.377614|   4.663793|        1.101821|      2.6128728|          0.0576138| -0.0438776|  14.16327|
