...
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 2 finished in 221.9 seconds.
#> Chain 1 finished in 227.1 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 224.5 seconds.
#> Total execution time: 227.1 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 1 finished in 69.9 seconds.
#> Chain 2 finished in 117.2 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 93.5 seconds.
#> Total execution time: 117.4 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 2 finished in 62.2 seconds.
#> Chain 1 finished in 65.7 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 64.0 seconds.
#> Total execution time: 65.8 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 1 finished in 144.5 seconds.
#> Chain 2 finished in 150.0 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 147.3 seconds.
#> Total execution time: 150.2 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 1 finished in 195.2 seconds.
#> Chain 2 finished in 208.6 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 201.9 seconds.
#> Total execution time: 208.7 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 2 finished in 126.3 seconds.
#> Chain 1 finished in 172.3 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 149.3 seconds.
#> Total execution time: 172.3 seconds.
#> 
#> Running MCMC with 2 parallel chains, with 2 thread(s) per chain...
#> 
#> Chain 1 finished in 159.4 seconds.
#> Chain 2 finished in 194.7 seconds.
#> 
#> Both chains finished successfully.
#> Mean chain execution time: 177.0 seconds.
#> Total execution time: 194.8 seconds.
