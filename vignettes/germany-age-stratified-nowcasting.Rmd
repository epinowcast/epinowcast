...
#> 1: refp_mean_int[1] 1.1380768 1.1298855 0.18017520 0.11698522 0.9640123
#> 2:   refp_sd_int[1] 2.6113605 2.6045484 0.19099615 0.13228284 2.4235703
#> 3:      sqrt_phi[1] 0.6422284 0.6419675 0.02747845 0.01889405 0.6120764
#>          q20       q80       q95     rhat  ess_bulk ess_tail
#>        <num>     <num>     <num>    <num>     <num>    <num>
#> 1: 1.0376644 1.2348034 1.3432420 1.001958  837.8219 691.2084
#> 2: 2.4977435 2.7208329 2.8333393 0.999320  944.7343 820.4451
#> 3: 0.6270766 0.6575628 0.6716316 1.000257 1332.9484 777.8975
```
...
#> Reference: Age and week, Report: Day of week          -0.9       5.5 
#> Reference: Age and week by age, Report: Day of week   -1.6       4.1 
#> Reference: Fixed, Report: Day of week                -87.7      11.3 
#> Reference: Fixed, Report: Fixed                     -617.9      45.9
```
...
As a first step we score overall performance.
...
Other performance characteristics are relatively similar across models (with all models being biased towards underprediction for example). 
...
|:--------------------------------------------------------|-------:|---:|----:|--------------:|---------------:|----------:|---------:|---:|---------:|-------:|
|Reference: Fixed, Report: Fixed                          | -0.0098| 6.1| 12.0|           4.20|             3.9|        4.1|       3.9|  17|        17|    1300|
|Reference: Fixed, Report: Day of week                    | -0.2400| 7.0| 12.0|           1.10|             7.3|        3.1|       4.2|  13|        15|     570|
|Reference: Age, Report: Day of week                      | -0.4000| 6.8| 10.0|           0.63|             6.5|        2.9|       4.3|  12|        13|     400|
|Reference: Age and week, Report: Day of week             |  0.0088| 5.5|  8.3|           3.10|             1.7|        3.5|       3.6|  15|        12|     540|
|Reference: Age and week by age, Report: Day of week      | -0.2100| 5.6|  8.3|           1.50|             3.3|        3.5|       3.7|  15|        12|     380|
|Independent by age, Reference: Week, Report: Day of week | -0.0260| 5.8|  9.7|           3.10|             1.4|        5.2|       3.7|  22|        14|    1100|



Finally we look across all scores relative to the simple model with no variation.
...
The difference in performance between the hierarchical by age models and the model that treats age groups independently is also very clear.
