...
The same centring is applied to the integrated drift of a shared autoregressive term (see the ARIMA vignette); grouped autoregressive terms and modules without a free intercept are left uncentred.
