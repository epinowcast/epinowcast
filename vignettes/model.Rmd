...
This distribution is discretised into daily probabilities $p_{g,t,d}$ (for a case in group $g$ with reference time $t$ to be reported with delay $d$) and adjusted for the maximum delay, see `vignette("distributions")` for details.
