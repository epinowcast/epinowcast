...
Note we normalise this distribution but assuming that all of the probability mass after the maximum delay is shifted to the last permissible delay. The parametric logit hazard (i.e. the probability of report at a given time conditional on not already having reported) for this component of the model is then,
