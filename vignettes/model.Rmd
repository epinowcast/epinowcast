...
The same idea applies to the integrated drift of an autoregressive term.
An integrated `arima()` residual has a free overall level (the cumulative sum lets the first shock shift the whole path) that trades off against the intercept, so its grand mean is removed and recovered into the intercept in the same way.
