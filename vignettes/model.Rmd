...
The same centring is applied to the integrated drift of any autoregressive term (see the ARIMA vignette), and modules without a free intercept are left uncentred.
