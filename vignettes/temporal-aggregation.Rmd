...
The fitted variant is the slowest as it has to learn the day-of-week effect from the full daily grid under sparse Wednesday-only signal and uses a lower `adapt_delta`; the daily benchmark sits between them.
