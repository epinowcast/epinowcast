...
All three daily-process models score similarly at the weekly resolution — the weekly observation scaffold tracks the full daily fit closely.
The pure weekly model is more conservative on the most recent weeks: with only four weekly observations in its nowcast horizon and a single weekly random walk to smooth them, it gives more weight to the prior and ends up wider than the daily models on the common scored weeks.
