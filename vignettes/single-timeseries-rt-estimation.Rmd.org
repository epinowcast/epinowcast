...
knitr::opts_chunk$set(
  fig.path = "figures/single-timeseries-rt-estimation/",
  collapse = TRUE,
  comment = "#>",
  eval = TRUE,
  cache = TRUE,
...
#| fig.cap: "Hospitalisations in Germany by date of positive test and date of report"
...
```{r plot-retro-germany-nowcast}
#| fig.cap: "Nowcast of hospitalisations in Germany based on retrospective data"
plot(
...
```{r plot-retro-germany-nowcast-obs}
#| fig.cap: "Posterior predictions of hospitalisations in Germany based on retrospective data" # nolint
...
```{r plot-germany-rt class.source = "fold-hide"}
#| fig.cap: "Real-time and retrospective estimates of the effective reproduction number in Germany" # nolint
...
```{r plot-germany-delay class.source = "fold-hide"}
#| fig.cap: "Real-time and retrospective estimates of the delay from testing positive to hospitalisation in Germany" # nolint
...
```{r plot-germany-reported-cases class.source = "fold-hide"}
#| fig.cap: "Real-time and retrospective estimates of the number of expected hospitalisations in Germany" #nolint
