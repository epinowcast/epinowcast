...
| **Inference methods** | NUTS, pathfinder, Laplace, pathfinder-initialised NUTS | [Inference methods vignette](inference-methods.html) |
...
| Laplace | Fast approximate inference (Gaussian at the mode) | `sampler = enw_laplace` | Exploration/debugging |
