...
| Stationary AR | Autocorrelation reverting to a mean | `~1 + ar(week, by = .group, p = 1)` | Mean-reverting trend |
| ARIMA residual | General time-series structure | `~1 + arima(week, by = .group, p = 1, d = 1)` | Flexible trend and autocorrelation |
