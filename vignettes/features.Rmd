...
| Susceptible depletion | Rt bends down as the susceptible pool depletes | `generation_time = c(...)`, `population = N` | [Susceptible depletion vignette](susceptible-depletion.html) |
