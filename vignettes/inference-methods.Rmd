...
|:-----------------------|:----------------------|-----------:|:---------|
|A (static delays)       |NUTS (prior init)      |        23.9|3.5       |
|A (static delays)       |NUTS (pathfinder init) |        27.9|7.7       |
|A (static delays)       |Pathfinder             |        15.6|-         |
|B (time-varying delays) |NUTS (prior init)      |       178.1|1         |
|B (time-varying delays) |NUTS (pathfinder init) |       212.9|0.8       |
|B (time-varying delays) |Pathfinder             |        63.8|-         |
...
|:-------------------------|-------:|--------:|---------------------:|--------------:|
|A: NUTS (prior init)      |    1000|     1.04|                    13|              8|
|A: NUTS (pathfinder init) |    1000|     1.03|                    10|              8|
|B: NUTS (prior init)      |    1000|     1.01|                     9|              7|
|B: NUTS (pathfinder init) |    1000|     1.01|                     1|              8|
...
|:-----------------------|:----------------------|:----------------|----:|-------------:|
|A (static delays)       |NUTS (prior init)      |refp_mean_int[1] | 2.43|          1.68|
|A (static delays)       |NUTS (prior init)      |refp_sd_int[1]   | 3.43|          0.72|
|A (static delays)       |NUTS (prior init)      |sqrt_phi[1]      | 1.51|          0.24|
|A (static delays)       |NUTS (pathfinder init) |refp_mean_int[1] | 2.44|          1.68|
|A (static delays)       |NUTS (pathfinder init) |refp_sd_int[1]   | 3.44|          0.73|
|A (static delays)       |NUTS (pathfinder init) |sqrt_phi[1]      | 1.50|          0.27|
|A (static delays)       |Pathfinder             |refp_mean_int[1] | 2.71|          0.20|
|A (static delays)       |Pathfinder             |refp_sd_int[1]   | 3.47|          0.15|
|A (static delays)       |Pathfinder             |sqrt_phi[1]      | 1.51|          0.10|
|B (time-varying delays) |NUTS (prior init)      |refp_mean_int[1] | 2.23|          2.06|
|B (time-varying delays) |NUTS (prior init)      |refp_sd_int[1]   | 3.10|          1.42|
|B (time-varying delays) |NUTS (prior init)      |sqrt_phi[1]      | 1.31|          0.24|
|B (time-varying delays) |NUTS (pathfinder init) |refp_mean_int[1] | 2.27|          1.91|
|B (time-varying delays) |NUTS (pathfinder init) |refp_sd_int[1]   | 3.10|          1.50|
|B (time-varying delays) |NUTS (pathfinder init) |sqrt_phi[1]      | 1.31|          0.24|
|B (time-varying delays) |Pathfinder             |refp_mean_int[1] | 1.93|          0.04|
|B (time-varying delays) |Pathfinder             |refp_sd_int[1]   | 3.17|          0.09|
|B (time-varying delays) |Pathfinder             |sqrt_phi[1]      | 1.15|          0.17|
...
#>         variable       mean         sd
#>           <char>      <num>      <num>
#> 1:  expr_beta_sd  0.4036645 0.14207666
#> 2:   refp_sd_int  3.4322323 0.21656517
#> 3:   rep_beta_sd  0.4158904 0.14610138
#> 4:      sqrt_phi  1.5056609 0.07607761
#> 5:    expr_r_int -0.0280433 0.12250671
#> 6: refp_mean_int  2.4343657 0.50024812
```
...
|Method                            | Runtime (s)|
|:---------------------------------|-----------:|
|Pathfinder (informed priors)      |         9.0|
|Pathfinder (default priors)       |        10.2|
|NUTS (default priors, full refit) |        24.7|
