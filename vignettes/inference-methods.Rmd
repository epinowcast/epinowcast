...
**Note:** A more refined way to handle this would be an `update()` method for `enw_preprocess_data` objects ([#429](https://github.com/epinowcast/epinowcast/issues/429)).
