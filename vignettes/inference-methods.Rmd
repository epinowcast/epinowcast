...
(prior init)      |        81.0|2.2       |
|A (static delays)       |NUTS
(pathfinder init) |        75.9|2.8       |
|A (static delays)       |Pathfinder            |        25.2|-         |
|B (time-varying delays) |NUTS
(prior init)      |       203.9|0.8       |
|B (time-varying delays) |NUTS
(pathfinder init) |       200.9|0.9       |
...
|A: NUTS (pathfinder init) |    1000|     1.01|                     8|             10|
|B: NUTS (prior init)      |    1000|     1.01|                     3|             10|
|B: NUTS (pathfinder init) |    1000|     1.02|                     0|              9|
...
|:-----------------------|:----------------------|:----------------|----:|-------------:|
|A (static delays)       |NUTS (prior init)      |refp_mean_int[1] | 3.89|          1.94|
|A (static delays)       |NUTS (prior init)      |refp_sd_int[1]   | 4.14|          0.86|
|A (static delays)       |NUTS (prior init)      |sqrt_phi[1]      | 1.84|          0.28|
|A (static delays)       |NUTS (pathfinder init) |refp_mean_int[1] | 4.00|          1.89|
|A (static delays)       |NUTS (pathfinder init) |refp_sd_int[1]   | 4.17|          0.80|
|A (static delays)       |NUTS (pathfinder init) |sqrt_phi[1]      | 1.83|          0.28|
|A (static delays)       |Pathfinder             |refp_mean_int[1] | 4.15|          1.19|
|A (static delays)       |Pathfinder             |refp_sd_int[1]   | 4.20|          0.51|
|A (static delays)       |Pathfinder             |sqrt_phi[1]      | 1.82|          0.24|
|B (time-varying delays) |NUTS (prior init)      |refp_mean_int[1] | 3.69|          2.27|
|B (time-varying delays) |NUTS (prior init)      |refp_sd_int[1]   | 3.95|          1.17|
|B (time-varying delays) |NUTS (prior init)      |sqrt_phi[1]      | 1.74|          0.27|
|B (time-varying delays) |NUTS (pathfinder init) |refp_mean_int[1] | 3.68|          2.23|
|B (time-varying delays) |NUTS (pathfinder init) |refp_sd_int[1]   | 3.91|          1.15|
|B (time-varying delays) |NUTS (pathfinder init) |sqrt_phi[1]      | 1.74|          0.29|
|B (time-varying delays) |Pathfinder             |refp_mean_int[1] | 4.73|          0.47|
|B (time-varying delays) |Pathfinder             |refp_sd_int[1]   | 4.07|          0.25|
|B (time-varying delays) |Pathfinder             |sqrt_phi[1]      | 1.71|          0.19|
...
#>         variable        mean         sd
#>           <char>       <num>      <num>
#> 1:    expr_r_int -0.01872553 0.12681494
#> 2:  expr_beta_sd  0.23973858 0.10354704
#> 3: refp_mean_int  3.89320849 0.59572794
#> 4:   refp_sd_int  4.14399003 0.25620880
#> 5:   rep_beta_sd  0.42772922 0.13877748
#> 6:      sqrt_phi  1.83561727 0.08458023
```
...
|Method                            | Runtime (s)|
|:---------------------------------|-----------:|
|Pathfinder (informed priors)      |         7.2|
|Pathfinder (default priors)       |        15.8|
|NUTS (default priors, full refit) |        74.2|
