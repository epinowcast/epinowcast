...
|:-----------------------|:----------------------|-----------:|:---------|
|A (static delays)       |NUTS (prior init)      |        74.0|3.4       |
|A (static delays)       |NUTS (pathfinder init) |        72.0|2.9       |
|A (static delays)       |Pathfinder             |        28.1|-         |
|B (time-varying delays) |NUTS (prior init)      |       193.0|1.5       |
|B (time-varying delays) |NUTS (pathfinder init) |       206.9|0.9       |
|B (time-varying delays) |Pathfinder             |        59.2|-         |
...
|B: NUTS (prior init)      |    1000|     1.01|                     6|              9|
|B: NUTS (pathfinder init) |    1000|     1.02|                     0|             10|
...
|:-----------------------|:----------------------|:----------------|----:|-------------:|
|A (static delays)       |NUTS (prior init)      |refp_mean_int[1] | 3.96|          2.02|
|A (static delays)       |NUTS (prior init)      |refp_sd_int[1]   | 4.16|          0.84|
|A (static delays)       |NUTS (prior init)      |sqrt_phi[1]      | 1.83|          0.27|
|A (static delays)       |NUTS (pathfinder init) |refp_mean_int[1] | 3.96|          2.01|
|A (static delays)       |NUTS (pathfinder init) |refp_sd_int[1]   | 4.16|          0.85|
|A (static delays)       |NUTS (pathfinder init) |sqrt_phi[1]      | 1.83|          0.27|
|A (static delays)       |Pathfinder             |refp_mean_int[1] | 3.98|          0.41|
|A (static delays)       |Pathfinder             |refp_sd_int[1]   | 4.20|          0.16|
|A (static delays)       |Pathfinder             |sqrt_phi[1]      | 1.77|          0.16|
|B (time-varying delays) |NUTS (prior init)      |refp_mean_int[1] | 3.66|          2.32|
|B (time-varying delays) |NUTS (prior init)      |refp_sd_int[1]   | 3.93|          1.12|
|B (time-varying delays) |NUTS (prior init)      |sqrt_phi[1]      | 1.73|          0.28|
|B (time-varying delays) |NUTS (pathfinder init) |refp_mean_int[1] | 3.67|          2.14|
|B (time-varying delays) |NUTS (pathfinder init) |refp_sd_int[1]   | 3.90|          1.14|
|B (time-varying delays) |NUTS (pathfinder init) |sqrt_phi[1]      | 1.74|          0.27|
|B (time-varying delays) |Pathfinder             |refp_mean_int[1] | 4.94|          0.28|
|B (time-varying delays) |Pathfinder             |refp_sd_int[1]   | 4.31|          0.17|
|B (time-varying delays) |Pathfinder             |sqrt_phi[1]      | 1.69|          0.08|
...
#>         variable         mean        sd
#>           <char>        <num>     <num>
#> 1:    expr_r_int -0.007612415 0.1164540
#> 2:  expr_beta_sd  0.242207767 0.1015083
#> 3: refp_mean_int  3.956114972 0.6262763
#> 4:   refp_sd_int  4.156000679 0.2608413
#> 5:   rep_beta_sd  0.429202417 0.1344537
#> 6:      sqrt_phi  1.829628515 0.0810334
```
...
|Method                            | Runtime (s)|
|:---------------------------------|-----------:|
|Pathfinder (informed priors)      |         8.1|
|Pathfinder (default priors)       |        26.4|
|NUTS (default priors, full refit) |        72.8|
