...
- [`as_forecast_sample(`*`<epinowcast>`*`)`](https://package.epinowcast.org/reference/as_forecast_sample.epinowcast.md)
...
- [`enw_example()`](https://package.epinowcast.org/reference/enw_example.md)
...
- [`enw_simulate_missing_reference()`](https://package.epinowcast.org/reference/enw_simulate_missing_reference.md)
