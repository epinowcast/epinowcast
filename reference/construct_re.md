...
- re:
  ...
  [`re()`](https://package.epinowcast.org/reference/re.md) which itself
  takes random effects specified in a model formula using the
...
- data:
  ...
  [`re()`](https://package.epinowcast.org/reference/re.md) term.
