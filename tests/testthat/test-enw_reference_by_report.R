...
test_that("enw_reference_by_report can make a look-up with 1 delay", {
  ...
  expect_identical(ref_by_rep[, report_date], complete_2[, report_date])
  expect_identical(as.numeric(ref_by_rep[1, -1]), c(3, 2))
  expect_identical(as.numeric(ref_by_rep[33, -1]), c(67, 66))
})
...
test_that("enw_reference_by_report can make a look-up with 5 delays", {
  ...
  expect_identical(ref_by_rep[, report_date], complete_5[, report_date])
  expect_identical(as.numeric(ref_by_rep[1, -1]), c(21, 17, 13, 9, 5))
  expect_identical(as.numeric(ref_by_rep[33, -1]), c(181, 177, 173, 169, 165))
})
