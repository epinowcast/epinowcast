test_that(
  "cache_location_message() returns correct message when 'enw_cache_location' is not set", # nolint: line_length
{
  withr::with_envvar(
    new = c(enw_cache_location = NA), {
    message <- cache_location_message()
...
test_that(
  "cache_location_message() returns correct message when 'enw_cache_location' is set", # nolint: line_length
{
