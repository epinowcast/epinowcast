...
test_that("enw_manual_formual can return a basic fixed effects formula", {
 expect_snapshot(enw_manual_formula(test_data, fixed = "day_of_week"))
})

test_that("enw_manual_formual can return a basic random effects formula", {
 expect_snapshot(enw_manual_formula(test_data, random = "day_of_week"))
})

test_that("enw_manual_formual can return a basic custom random effects
           formula", {
