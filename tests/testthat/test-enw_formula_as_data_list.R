...
test_that("enw_formula_as_data_list produces expected output using a simple formula", {
  expect_snapshot(
...
test_that("enw_formula_as_data_list produces expected output using a more complex formula", {
  expect_snapshot(
    enw_formula_as_data_list(
...
test_that("enw_formula_as_data_list produces expected default output", {
  expect_equal(
    ...
    list(
      c_fdesign = numeric(0), c_fintercept = 0, c_fnrow = 0, c_findex = numeric(0), c_fnindex = 0,
